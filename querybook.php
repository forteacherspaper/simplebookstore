...
<div id="header">
   <div id="orderBg">
      <div id="orderInfo">
<?php 
echo '��'.$test_title.'�ԡ�[<font color=blue>'.$row['test_sub'].'</font>]�������';
if($_GET['ms']==lx){echo '&nbsp;&nbsp;<font color=red>��ϰģʽ</font>';}
if($_GET['ms']==ks){echo '&nbsp;&nbsp;<font color=red>����ģʽ</font>';}
?> 
</div></div></div>
<div id="test">      
...
if($_POST['tg']){  
   ...
   while(list($k,$v) = each($a)){
	  ...
	  if($_GET['ms']==lx){ echo '�ο���<br><li>'.$ansbrief['brief_ans'].'<br>';}
