	...
	<body bgcolor="#f4f4f4">
		<table width="100%" border="0" align="center">
		     ...
		     <tr>
		     	...
		     	<td><input name="BookAuthor" type="text" id="BookAuthor" size="20" value="<?php echo $row_Book['bookauthor']; ?>" /></td>
		     </tr>
		      <tr>
		     	<td align="center">图书价格</td>
		     	<td><input name="BookPrice" type="text" id="BookPrice" size="20" value="<?php echo $row_Book['bookpricerice'];?>" /></td>
		     </tr>
